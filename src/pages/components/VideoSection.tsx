            ...
            <div className="container mx-auto px-4">
                <div className="relative group max-w-5xl mx-auto rounded-3xl overflow-hidden shadow-2xl">
                    ...
                    <div className="absolute inset-0 bg-black/30 flex items-center justify-center transition-all duration-500 group-hover:bg-black/20">
                        {/* Play Button */}
                        <Link to={'https://www.youtube.com/@FemtechTraining'} target="_blank" className="w-16 h-16 md:w-24 md:h-24 bg-white/20 backdrop-blur-md rounded-full flex items-center justify-center border-2 md:border-4 border-white text-white group-hover:scale-110 group-hover:bg-secondary group-hover:border-secondary transition-all duration-500">
